...
class PackageInfoDebug {
  ...
  static Future<String?> getAndroidPackageName() async {
    try {
      ...
      debugPrint(
          '   3. Find site key: 6LdjbvgrAAAAAINsAjihWllPukIAyNdXctSkNKo5');
      ...
      debugPrint(
          '📱 Expected Package Names (add ALL to Google Cloud Console):');
      debugPrint('   ✅ com.burgereat.gigafaucet         (Production)');
      debugPrint('   ✅ com.burgereat.gigafaucet.dev     (Development)');
      debugPrint('   ✅ com.burgereat.gigafaucet.staging (Staging)');
      debugPrint('');
      debugPrint(
          '🔧 Quick Fix: Add these 3 package names to your reCAPTCHA Enterprise site key');
  ...
  static void showPackageNameSolution() {
    ...
    debugPrint('   • com.burgereat.gigafaucet         (Production flavor)');
    debugPrint('   • com.burgereat.gigafaucet.dev     (Development flavor)');
    debugPrint('   • com.burgereat.gigafaucet.staging (Staging flavor)');
    debugPrint('');
    ...
    debugPrint('   2. Navigate to: Security → reCAPTCHA Enterprise');
    debugPrint(
        '   3. Click on your site key: 6LdjbvgrAAAAAINsAjihWllPukIAyNdXctSkNKo5');
    debugPrint(
        '   4. In "Android applications" section, add ALL 3 package names above');
    debugPrint('   5. Save the configuration');
    debugPrint('');
    debugPrint(
        '✅ After adding package names, your reCAPTCHA will work correctly!');
    debugPrint('');
  }
}
