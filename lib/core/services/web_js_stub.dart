...
extension JSObjectExtension on Object {
  JSObject get jsify => throw UnsupportedError('JS interop not available on non-web platforms');
}

extension StringToJS on String {
  dynamic get toJS => throw UnsupportedError('JS interop not available on non-web platforms');
}
