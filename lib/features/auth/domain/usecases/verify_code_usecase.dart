...
class VerifyCodeUseCase implements UseCase<VerifyCodeResponse, VerifyCodeRequest> {
  ...
  @override
  Future<Either<Failure, VerifyCodeResponse>> call(VerifyCodeRequest params) async {
