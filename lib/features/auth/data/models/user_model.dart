...
class UserModel extends User {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      securityPinRequired: _parseBool(json['security_pin_required']),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'security_pin_required': securityPinRequired,
      'is_banned': isBanned,
  ...
  factory UserModel.fromEntity(User user) {
    return UserModel(
      ...
      securityPinRequired: user.securityPinRequired,
  ...
  factory UserModel.fromDatabaseJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      twofaSecret: json['twofa_secret'] as String? ?? '',
      securityPinRequired: json['security_pin_required'] as int? ?? 0,
  ...
  User toEntity() {
    return User(
        ...
        securityPinRequired: securityPinRequired,
        isBanned: isBanned,
