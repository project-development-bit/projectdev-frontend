...
class _ResetPasswordPageState extends ConsumerState<ResetPasswordPage> {
  ...
  void _handleResetSuccess() {
    ...
    context.showSuccessSnackBar(
      message: l10n?.translate('password_reset_successful') ?? 'Password reset successfully! Please login with your new password.',
    );
    ...
    Future.delayed(const Duration(milliseconds: 2000), () {
      if (mounted) {
        ...
        debugPrint('Reset Password Success: Widget not mounted, skipping navigation');
      }
    });
  }
  ...
  String? _validatePassword(String? value) {
    ...
    if (value == null || value.isEmpty) {
      return l10n?.translate('please_enter_password') ?? 'Please enter a password';
    }
    if (value.length < 8) {
      return l10n?.translate('password_min_8_chars') ?? 'Password must be at least 8 characters long';
    }
    return null;
  }
  ...
  String? _validateConfirmPassword(String? value) {
    final l10n = AppLocalizations.of(context);
    if (value == null || value.isEmpty) {
      return l10n?.translate('please_confirm_password') ?? 'Please confirm your password';
    }
    if (value != _passwordController.text) {
      return l10n?.translate('passwords_must_match') ?? 'Passwords do not match';
    }
    return null;
  }
    ...
    return Column(
      ...
      children: [
        ...
        CommonText.bodySmall(
          l10n?.translate('password_requirements') ?? 'Password must be at least 8 characters long',
          textAlign: TextAlign.center,
          color: Theme.of(context).colorScheme.onSurfaceVariant,
        ),
      ],
    ...
    return Column(
      children: [
        ...
        CommonTextField(
          ...
          hintText: l10n?.translate('enter_new_password') ?? 'Enter your new password',
        ...
        CommonTextField(
          ...
          labelText: l10n?.translate('confirm_new_password') ?? 'Confirm Password',
          hintText: l10n?.translate('confirm_new_password') ?? 'Confirm your new password',
          prefixIcon: const Icon(Icons.lock_outline),
          suffixIcon: IconButton(
            icon: Icon(
  ...
  Widget _buildResetButton(BuildContext context, AppLocalizations? l10n, bool isLoading) {
    return CommonButton(
