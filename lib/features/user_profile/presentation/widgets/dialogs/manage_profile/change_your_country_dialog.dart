        ...
        children: [
          ...
          if (countriesState.isLoading)
                ...
                child: Column(
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Text(context.translate("retry_button")),
                    ),
                  ],
                ),
              ),
            ...
            CommonDropdownFieldWithIcon<Country>(
              ...
              label: context.translate("country_label"),
          ...
          CommonButton(
            ...
            onPressed: _selectedCountry != null
                ? () {
                    // TODO: Implement country update logic
                    Navigator.of(context).pop(_selectedCountry?.code);
                  }
                : null,
          ),
        ],
