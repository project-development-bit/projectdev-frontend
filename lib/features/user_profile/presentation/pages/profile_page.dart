...
import '../../../auth/presentation/providers/check_2fa_status_provider.dart';
import '../../../auth/presentation/widgets/disable_2fa_confirmation_dialog.dart';
                      ...
                      if (item['title'] == '2FA') {
                        context.show2FAVerificationDialog(
                          onSuccess: () {
                            // Refresh 2FA status after successful enable
                            ref
                                .read(check2FAStatusProvider.notifier)
                                .check2FAStatus();
                          },
                        );
                      }
