...
void main() {
  group('ResetPasswordPage Widget Tests', () {
    ...
    group('UI Elements', () {
      ...
      testWidgets('should display header section with email', (WidgetTester tester) async {
        // Act
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
      ...
      testWidgets('should display password input fields', (WidgetTester tester) async {
        // Act
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
      ...
      testWidgets('should display password visibility toggles', (WidgetTester tester) async {
        // Act
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
      ...
      testWidgets('should display reset password button', (WidgetTester tester) async {
        // Act
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
        ...
        expect(find.text('Reset Password'), findsNWidgets(2)); // One in app bar, one in button
      });

      testWidgets('should display back to login link', (WidgetTester tester) async {
        // Act
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
    ...
    group('User Interactions', () {
      testWidgets('should toggle password visibility when visibility icon is tapped', (WidgetTester tester) async {
        // Arrange
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
      ...
      testWidgets('should enter text in password fields', (WidgetTester tester) async {
        // Arrange
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();

        // Act
        await tester.enterText(find.byType(CommonTextField).first, 'newpassword123');
        await tester.enterText(find.byType(CommonTextField).last, 'newpassword123');
        await tester.pumpAndSettle();
      ...
      testWidgets('should show loading state when reset password is in progress', (WidgetTester tester) async {
        // Arrange
    ...
    group('Form Validation', () {
      testWidgets('should show validation error for short password', (WidgetTester tester) async {
        ...
        // Assert
        expect(find.text('Password must be at least 8 characters long'), findsWidgets);
      });

      testWidgets('should show validation error when passwords do not match', (WidgetTester tester) async {
        // Arrange
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();

        // Act
        await tester.enterText(find.byType(CommonTextField).first, 'password123');
        await tester.enterText(find.byType(CommonTextField).last, 'differentpassword');
        await tester.tap(find.byType(CommonButton));
        await tester.pumpAndSettle();
      ...
      testWidgets('should submit form when all validations pass', (WidgetTester tester) async {
        // Arrange
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();

        // Act
        await tester.enterText(find.byType(CommonTextField).first, 'validpassword123');
        await tester.enterText(find.byType(CommonTextField).last, 'validpassword123');
        await tester.tap(find.byType(CommonButton));
        await tester.pumpAndSettle();
    ...
    group('Navigation', () {
      testWidgets('should attempt navigation when back to login is tapped', (WidgetTester tester) async {
        // Arrange
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
